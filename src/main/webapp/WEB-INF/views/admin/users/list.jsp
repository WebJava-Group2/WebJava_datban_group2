        ...
        <nav aria-label="Page navigation" class="mt-4">
          <ul class="pagination justify-content-center">
            <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
              <a class="page-link"
                 href="${pageContext.request.contextPath}/admin/users?page=${currentPage - 1}&itemsPerPage=${itemsPerPage}"
                 aria-label="Previous">
            ...
            <li class="page-item ${currentPage == 1 ? 'active' : ''}">
              <a class="page-link"
                 href="${pageContext.request.contextPath}/admin/users?page=1&itemsPerPage=${itemsPerPage}">
                1
              </a>
            </li>
            ...
            <c:forEach begin="${Math.max(2, currentPage - 2)}"
              ...
              <li class="page-item ${currentPage == i ? 'active' : ''}">
                <a class="page-link"
                   href="${pageContext.request.contextPath}/admin/users?page=${i}&itemsPerPage=${itemsPerPage}">
                    ${i}
                </a>
              </li>
            </c:forEach>
            ...
            <c:if test="${totalPages > 1}">
              <li class="page-item ${currentPage == totalPages ? 'active' : ''}">
                <a class="page-link"
                   href="${pageContext.request.contextPath}/admin/users?page=${totalPages}&itemsPerPage=${itemsPerPage}">
                    ${totalPages}
                </a>
              </li>
            </c:if>
