...
<body class="index-page">
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4 justify-content-center justify-content-lg-between">
          ...
          <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
            <img src="${pageContext.request.contextPath}/client/assets/img/hero-img.png" class="img-fluid animated" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
            <img src="${pageContext.request.contextPath}/client/assets/img/about.jpg" class="img-fluid mb-4" alt="">
          ...
          <div class="col-lg-5" data-aos="fade-up" data-aos-delay="250">
            <div class="content ps-0 ps-lg-5">
              ...
              <div class="position-relative mt-4">
                <img src="${pageContext.request.contextPath}/client/assets/img/about-2.jpg" class="img-fluid" alt="">
    ...
    <section id="stats" class="stats section dark-background">
      ...
      <img src="${pageContext.request.contextPath}/client/assets/img/stats-bg.jpg" alt="" data-aos="fade-in">
              ...
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="${pageContext.request.contextPath}/client/assets/img/testimonials/testimonials-1.jpg" class="img-fluid testimonial-img" alt="">
                  </div>
                </div>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="${pageContext.request.contextPath}/client/assets/img/testimonials/testimonials-2.jpg" class="img-fluid testimonial-img" alt="">
                  </div>
                </div>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="${pageContext.request.contextPath}/client/assets/img/testimonials/testimonials-3.jpg" class="img-fluid testimonial-img" alt="">
                  </div>
                </div>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <div class="row gy-4 justify-content-center">
                  ...
                  <div class="col-lg-2 text-center">
                    <img src="${pageContext.request.contextPath}/client/assets/img/testimonials/testimonials-4.jpg" class="img-fluid testimonial-img" alt="">
                  </div>
                </div>
              </div>
            </div><!-- End testimonial item -->
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member">
              <div class="member-img">
                <img src="${pageContext.request.contextPath}/client/assets/img/chefs/chefs-1.jpg" class="img-fluid" alt="">
                <div class="social">
          ...
          <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="${pageContext.request.contextPath}/client/assets/img/chefs/chefs-2.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member">
              <div class="member-img">
                <img src="${pageContext.request.contextPath}/client/assets/img/chefs/chefs-3.jpg" class="img-fluid" alt="">
                <div class="social">
                  <a href=""><i class="bi bi-twitter-x"></i></a>
                  <a href=""><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="/webjava_war_exploded/client/assets/img/gallery/gallery-1.jpg"><img src="/webjava_war_exploded/client/assets/img/gallery/gallery-1.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="/webjava_war_exploded/client/assets/img/gallery/gallery-2.jpg"><img src="/webjava_war_exploded/client/assets/img/gallery/gallery-2.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="/webjava_war_exploded/client/assets/img/gallery/gallery-3.jpg"><img src="/webjava_war_exploded/client/assets/img/gallery/gallery-3.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="/webjava_war_exploded/client/assets/img/gallery/gallery-4.jpg"><img src="/webjava_war_exploded/client/assets/img/gallery/gallery-4.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="/webjava_war_exploded/client/assets/img/gallery/gallery-5.jpg"><img src="/webjava_war_exploded/client/assets/img/gallery/gallery-5.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="/webjava_war_exploded/client/assets/img/gallery/gallery-6.jpg"><img src="/webjava_war_exploded/client/assets/img/gallery/gallery-6.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="/webjava_war_exploded/client/assets/img/gallery/gallery-7.jpg"><img src="/webjava_war_exploded/client/assets/img/gallery/gallery-7.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="/webjava_war_exploded/client/assets/img/gallery/gallery-8.jpg"><img src="/webjava_war_exploded/client/assets/img/gallery/gallery-8.jpg" class="img-fluid" alt=""></a></div>
          </div>
          <div class="swiper-pagination"></div>
        </div>
